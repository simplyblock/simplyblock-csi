...
| `node.tolerations.effect`       | The effect of tolerations on the csi node	                                                                          | `NoSchedule`                                                               |  |
| `node.tolerations.key	`        | The key of tolerations for the csi node	                                                                            | `dedicated`                                                                |  |
| `node.tolerations.operator	`    | The operator for the csi node tolerations	                                                                          |                                            `Equal`                                                                    |  |
| `node.tolerations.value	`      | The value of tolerations for the csi node	                                                                          |                                            `simplyblock-cache`                                                        |  |
| `node.nodeSelector`             | The node selector to specify which nodes the csi node DaemonSet should run on                                         | `simplyblock-cache`                                                        |  |
